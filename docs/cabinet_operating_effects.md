...
## Corruption/clientelism extension

Each portfolio runtime also tracks:
- corruption pressure
- corruption yield
- exposure risk
- corruption memory

Cabinet-level state tracks:
- corruption load
- gray fund
- scandal hooks

These values create short-term benefits (cash/network/discipline) and long-term penalties (competence decay, scandal hooks, coalition stress).
